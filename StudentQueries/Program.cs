...
namespace StudentQueries
{
	class Program
	{
		static void CopyToDatabase(MishakinContext context)
		{
		...
		static void FilterAndOrder(MishakinContext context)
		{
		...
		static void Join(MishakinContext context)
		{
			var result = from s in context.Students
		...
		static void GroupByFirstLetter(MishakinContext context)
		{
			var result = from s in context.Students
		...
		{
			using (MishakinContext c = new MishakinContext())
			{
